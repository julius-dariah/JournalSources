...
BLOG_AUTHOR = "Julius Peinelt @ DARIAH-ERIC"  # (translatable)
BLOG_TITLE = "Digital Humanities in Practice"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://julius-dariah.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "julius.peinelt@dariah.eu"
BLOG_DESCRIPTION = "A central hub for methods in the digital humanities."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ("/index.html", "Home"),
        ("/stories/introduction/index.html", "HowTo"),
...
# is in the manual.
COMMENT_SYSTEM_ID = "digitalhumanitiesinpractice"
